...
<td width="72" align="center"><img alt="<!--[$race]-->" title="<!--[$race]-->" src="/imgs/factions/<!--[$race|lower]-->.png" width="64" height="64" hspace="10" /></td>
                    ...
                    <td style="cursor:default; background-image:url('https://imageserver.eveonline.com/Render/<!--[$ship.typeID]-->_128.png'); background-position:center; background-repeat:no-repeat; background-size:64px 64px; padding: 3px;" valign="top" align="center" onmouseover="this.style.backgroundColor='#303030';" onmouseout="this.style.backgroundColor='#1B1B1B'"><a style="cursor:zoom-in;" href="/ship/<!--[$ship.typeName]-->" rel="iframe-full-full" class="pirobox" title="<!--[$ship.typeName]-->"><!--[if $ship.tag >= 4]--><img src="/imgs/isis/faction.png"/><!--[elseif $ship.tag == 3]--><img src="/imgs/isis/tech3.png"/><!--[elseif $ship.tag == 2]--><img  src="/imgs/isis/tech2.png"/><!--[else $ship.tag == 1]--><img src="/imgs/isis/t1.png"/><!--[/if]--><br /></a><div style="bottom:0px; left:0px; width:64px; text-align:center; padding:0 0.5em; -moz-box-sizing:border-box; box-sizing:border-box; background-color: rgba(15, 15, 15, 0.4); font-size:xx-small; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;"><!--[$ship.typeName]--></div></td>
                <!--[/foreach]-->
                </tr>
              </table>
              </div>
