      ...
      <!--[else]-->
        <!--[foreach item=char from=$charlist.chars]-->
          &nbsp;&nbsp;<a href="<!--[$char.charname]-->" title="<!--[$char.charname]-->"><img src="http://image.eveonline.com/Character/<!--[$characterID]-->_32.jpg" class="mbAvatar" style="border:1px solid gray;" alt="<!--[$char.charname]-->" /></a>
        <!--[/foreach]-->
      <!--[/if]-->
      </div>
