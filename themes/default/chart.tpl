...
<script type="text/javascript">
           FusionCharts.ready(function () {
               var spChart = new FusionCharts({
                   ...
                   "height": "430",
                   "dataFormat": "xml",
                   "dataSource": "<chart caption='<!--[$name]-->' subcaption='Skillpoint Distribution' yaxisname='Skillpoints' bgalpha='100' borderalpha='20' canvasborderalpha='0' useplotgradientcolor='1' plotborderalpha='10' placevaluesinside='0' rotateValues='1' labelDisplay='Rotate' slantLabels='1' valuefontcolor='#333333' captionpadding='10' showaxislines='1' axislinealpha='25' divlinealpha='75' canvasBaseDepth='1' bgColor='#333333' canvasBaseColor='#666666' baseFontColor='#fff' baseFont='Open Sans' baseFontSize='11' tooltipBgColor='#333' tooltipSepChar=': ' formatNumberScale='0' numberSuffix=''><!--[foreach item='grp' from=$grptable]--><set label='<!--[$grp.grpname]-->' value='<!--[$grp.spcount2]-->' /><!--[/foreach]--></chart>"
    });
               spChart.render();
           });
        </script> 
