...
<!-- HEADER -->
  ...
  <!--[if $page]-->
<span class="headerleft"><img align="left" style="border:#666 1px solid; margin:3px;" src="<!--[getportrait characterID=$characterID size=64]-->" width="32" height="32" title="" alt="<!--[$name]-->" /></a><!--[if $page eq 'skills']-->Skillsheet for <!--[elseif $page eq 'ships']--> Flyable ships for <!--[elseif $page eq 'siglist']-->Signatures for <!--[/if]--><span style="color:gold;"><!--[$name]--></span><br />Member of <a style="text-decoration:none;" href="https://gate.eveonline.com/Corporation/<!--[$corporationName|replace:" ":"%20"]-->" rel="iframe-875-610" class="pirobox"><!--[$corporationName]--></a><!--[if $allianceName neq '']--> <a style="text-decoration:none;" href="https://gate.eveonline.com/Alliance/<!--[$allianceName|replace:" ":"%20"]-->" rel="iframe-875-610" class="pirobox"> [<!--[$allianceName]-->]</a><!--[else]--><!--[/if]--></span>
