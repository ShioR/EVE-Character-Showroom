...
<body bgcolor="#1B1B1B" style="height: 100%">
  ...
  <div id="content" class="mcenter" style="float:center;width:908px;margin-top:50px;" >
    ...
    <tbody>
      <tr>
        <td>Your character has been deleted.<br />Please leave us some <a target="_blank" href="http://txsi.co.uk/trac/newticket/" title="Feedback">feedback!</a><br /><a href="javascript:window.close()" title="Close Window">Close Window</a></td>
      </tr>   
     </tbody>
    </table>  
<br />
