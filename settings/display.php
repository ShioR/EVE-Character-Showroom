...
<body bgcolor="#1B1B1B" style="height: 100%">
        ...
        <div id="content" style="margin-left:10px;width:70%;margin-top:30px;" >
          <div class="block-header2">Show/Hide Character</div>
          <br />
        <form id="Update_Settings" name="Update_Settings" method='post' action='display_updated.php'>
        ...
        <tr>
          <td bgcolor='#1B1B1B'><strong>Public? (0 or 1)</strong></td>
          <td bgcolor='#1B1B1B' align='center'><input type ='text' class='bginput' name='public'></td>
        </tr>             
        <tr>
        <td></td>
