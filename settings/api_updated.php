...
$query="UPDATE skillsheet_apis SET keyID ='$keyID2', vCode='$vCode2' WHERE keyID='$keyID' AND vCode='$vCode'";
...
<br />
  ...
  <tbody>
    ...
    <tr><td style="text-align: center; font-size: x-small;"><a style="text-decoration: none;color:grey;" href="#top" title="Strap in baby, we\'re going express to the top!">Top</a> / <a style="text-decoration: none;color:grey;" target="_blank" href="https://github.com/ShioR/EVE-Character-Showroom/commits/master/" title="Github">';echo _DATA_VERSION; echo '&nbsp;'; echo _SKILLSHEET_VERSION; echo'</a> / <a style="text-decoration: none;color:grey;" target="_blank" href="https://github.com/ShioR/EVE-Character-Showroom/issues/new" title="Bugs">Submit Bug</a>ation: none;color:grey;" target="_blank" href="https://github.com/ShioR/EVE-Character-Showroom/issues/new" title="Feedback">Feedback</a>
</td>
</tr>
<tr>
<td>
