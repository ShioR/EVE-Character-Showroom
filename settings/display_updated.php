...
<body bgcolor="#1B1B1B" style="height: 100%">
  ...
  <div id="content" class="mcenter" style="float:center;width:908px;margin-top:50px;" >
    ...
    <tbody>
      <tr>
        <td>Your characters display settings have been changed.<br />This will either include, or exclude you from the stats.<br /><a href="javascript:window.close()" title="Close Window">Close Window</a></td>
      </tr>   
     </tbody>
    </table>  
<br />
