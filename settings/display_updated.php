...
$query="UPDATE skillsheet_apis SET public='$public' WHERE name='$name' and vCode='$vCode' and keyID='$keyID'";
...
<body bgcolor="#1B1B1B" style="height: 100%">
  ...
  <div id="content" class="mcenter" style="float:center;width:400px;margin-top:30px;" >
    ...
    <tbody>
      <tr>
        <td>Your characters display settings have been changed.<br /><br />This will either include, or exclude you from the stats.<br /></td>
      </tr>   
     </tbody>
    </table>  
<br />
...
<br />
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align: center; font-size: x-small;"><a style="text-decoration: none;color:grey;" href="#top" title="Strap in baby, we\'re going express to the top!">Top</a> / <a style="text-decoration: none;color:grey;" target="_blank" href="https://github.com/ShioR/EVE-Character-Showroom/commits/master/" title="Github">';echo _DATA_VERSION; echo '&nbsp;'; echo _SKILLSHEET_VERSION; echo'</a> / <a style="text-decoration: none;color:grey;" target="_blank" href="https://github.com/ShioR/EVE-Character-Showroom/issues/new" title="Bugs">Submit Bug</a>ation: none;color:grey;" target="_blank" href="https://github.com/ShioR/EVE-Character-Showroom/issues/new" title="Feedback">Feedback</a>
</td>
</tr>
<tr>
<td>
