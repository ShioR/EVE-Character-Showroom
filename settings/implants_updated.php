...
<body bgcolor="#1B1B1B" style="height: 100%">
  ...
  <div id="content" class="mcenter" style="float:center;width:908px;margin-top:50px;" >
    ...
    <tbody>
      <tr>
        <td>Your characters implant data visibility settings have been changed.<br />This will remove the values from your character sheet.<br /><a href="javascript:window.close()" title="Close Window">Close Window</a></td>
      </tr>   
     </tbody>
    </table>  
<br />
