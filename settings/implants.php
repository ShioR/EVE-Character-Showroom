...
<body bgcolor="#1B1B1B" style="height: 100%">
        ...
        <div id="content" style="margin-left:10px;width:70%;margin-top:30px;" >
          <div class="block-header2">Show/Hide Implant Data</div>
          <br />
        <form id="Update_Implants" name="Update_Implants" method='post' action='implants_updated.php'>
        ...
        <tr>
          <td bgcolor='#1B1B1B'><strong>Implants Visible? (0 or 1)</strong></td>
          <td bgcolor='#1B1B1B' align='center'><input type ='text' class='bginput' name='implants'></td>
        </tr>             
        <tr>
        <td></td>
        <td bgcolor='#1B1B1B' align='center'><input type='submit' value='Show/Hide Implant Data'></td>
        </tr>
        <tr>
...
$result = mysql_query("SELECT name FROM skillsheet_apis WHERE keyID='".$keyID."' and vCode='".$vCode."'"); 
...
$implants=mysql_result($result,$i,"implants");
