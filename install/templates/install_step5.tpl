...
<div class="headerribbon">
  ...
  <span class="headerright"  style="color:gold;"><a href="/" title="Skills Shrowroom">Showroom: Characters List</a></span>
        ...
        <div id="content" style="margin-left:10px;width:70%;margin-top:50px;" >
          ...
          <br />
        <!--[if $submit]-->
          <form id="addcharacters" method="post" action="install.php?step=6">
          <div>
            ...
            <!--[/if]-->
              ...
              <tr>
            <!--[if $error]-->
                <td class="txtcenter"><a href="install.php?step=5" title="Go Back">Back to API Form</a></td>
            <!--[else]-->
        ...
        <!--[else]-->
        <form id="options" name="options" method='post' action='install.php?step=5'>
        <table border='0' cellspacing='0' cellpadding='0' align='left'>
        <tr id='cat'>
        <tr>
          <td bgcolor='#1B1B1B'><strong>keyID:</strong></td>
          <td bgcolor='#1B1B1B' align='center'><input id="keyID" name="keyID" type="text" tabindex="1"></td>
        </tr>
        <tr>
          <td bgcolor='#1B1B1B'><strong>API Key:</strong></td>
        ...
        <tr>
           <td colspan='2'></br></br><span class="newsmalltext">Your <strong><i>limited</i></strong> API key can be found <a target="_blank" href="http://eve.is/api/">here</a></span></td>
         </tr>
          </form>
        <!--[/if]-->
        </div>
