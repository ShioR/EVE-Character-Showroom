...
{
    global $corporationID, $domain;
    $path = '../cache/corps/';
    if (!file_exists($path.$corporationID.'_256.png')) {

      $distantImg = 'https://imageserver.eveonline.com/Corporation/'.$corporationID.'_256.png';

        $local    = $path.$corporationID;
        $localimage = $path.$corporationID.'_256.png';
        ...
        return '../cache/corps/'.$corporationID.'_256.png';
